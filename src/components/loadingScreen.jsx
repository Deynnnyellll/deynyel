...
export const LoadingScreen = ({count, isLoading}) => {
  ...
  return (
    <div className={isLoading ? "bg-[#0F0F0F] absolute left-0 w-full h-[100vh] flex flex-col items-center justify-center gap-8" : "bg-black absolute left-[-100%] w-full h-[100vh] flex flex-col items-center justify-center gap-4 duration-700 ease-out"}>
