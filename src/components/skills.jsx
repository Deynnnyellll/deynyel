...
const Skills = () => {
  ...
  return (
    <div ref={ref} className={isVisible ? 
                              "mt-20 md:w-[65%] w-[85%] md:h-[450px] relative z-50 left-[50%] translate-x-[-50%] ease-in-out duration-500" : "mt-20 md:w-[60%] w-[85%] md:h-[400px] relative z-50 left-[-60%] ease-in-out duration-500"
                            }>
        <div className="w-full h-full outline outline-3 outline-[#864AF9] text-white py-8 px-6 rounded-xl flex flex-col items-center justify-between shadow-[#372e49] shadow-md"> 
          ...
          <div className="h-full w-full flex flex-col md:flex-row items-center md:mt-10 md:items-start justify-between">
            {
              skills.map(skill => (
                <div key={skill.id} className="bg-[#068FFF] mt-8 md:mt-[-2%] flex flex-col items-center justify-center w-full p-4 rounded-lg md:h-[95%] md:w-[30%] text-center">
