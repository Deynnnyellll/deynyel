  ...
  return (
    <div id="about" className="h-auto mt-10 px-2">
        ...
        <div className="flex justify-center flex-col md:flex-row items-center h-[75%] md:gap-14 lg:gap-24">
            <p className="w-[85%] md:w-[50%] lg:w-[40%] text-justify text-lg md:text-xl lg:text-2xl"> I am a front-end web developer, python developer and a machine learning engineer who
